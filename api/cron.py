"""Vercel Cron: ежедневная рассылка наборов в 10:00 МСК (07:00 UTC).

Расписание задаётся в vercel.json (crons → "0 7 * * *"). Vercel дёргает этот
эндпойнт раз в сутки; функция шлёт дневной набор каждому зарегистрированному
ученику. Время рассылки единое для всех (10:00 МСК), поэтому персональные
